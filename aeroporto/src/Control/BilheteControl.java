...
private ObservableList<Bilhete> lista = FXCollections.observableArrayList();
	...
	public Bilhete getBilhete() { 
		...
		b.setSituacaoBilhete(situacaoBilheteProperty.get());
	...
	public void setBilhete(Bilhete b) { 
		if (b != null)  { 
			...
			situacaoBilheteProperty.setValue(b.getSituacaoBilhete());
	...
	public void pesquisarTodos() throws BilheteException {
		List<Bilhete> Bilhetes = BilheteDAO.pesquisarTodos();
		this.lista.clear();
		this.lista.addAll(Bilhetes);
	}
